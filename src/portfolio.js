...
const greeting = {
  ...
  subTitle: emoji(
    "A passionate Full Stack Software Developer 🚀 with experience in building Web and Mobile applications using JavaScript, React.js, Node.js, React Native, and various modern frameworks. Skilled in Machine Learning and Generative AI, leveraging data-driven solutions to build intelligent applications."
  ),
  resumeLink:
